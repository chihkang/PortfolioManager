...
1. **Analyze Repository Changes**
   ...
   - Specifically check if changes affect the project overview, installation, or usage instructions in `README.md`
...
3. **Create or Update Documentation**
   ...
   - Update `README.md` if the changes affect the project's high-level description, setup, or key features
